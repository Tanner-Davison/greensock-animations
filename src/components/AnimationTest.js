...
const AnimationTest = () => {
  ...
  useEffect(() => {
    const xValue = getMedia(-1150, -500, -340, -170)
    const additionOne = getMedia(200, 100, 80, 40)
    const additionTwo = getMedia(400, 200, 150, 75)
    const additionThree = getMedia(600, 300, 250, 110)
    const additionFour = getMedia(800, 400, 325, 140)
